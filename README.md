...
- 🗺️ Country filter: select one or more countries to filter by.
...
### ⏱️ Sales by Product Line Over Time
...
- Initialize the local SQLite database (creates `data/users.db` and seeds users): 🗄️
